...
class Event(OBISTable):
    ...
    _parentEvent = models.ForeignKey('Event', blank=True, null=True, default=None, on_delete=models.SET_DEFAULT,
    ...
    def eventDate(self)->str:
        ...
        if (self._event_start_dt and self._event_end_dt):
            start_dt_str = OBISTable.obis_datetime_str(self._event_start_dt, self._event_start_dt_p)
            end_dt_str = OBISTable.obis_datetime_str(self._event_start_dt, self._event_end_dt_p)
    ...
    _event_start_dt = models.DateTimeField(blank=True, null=True, default=None, verbose_name="Private datetime variable for the start date")
    _event_start_dt_p = models.IntegerField(verbose_name="Private datetime variable for the start date precision",
                                                      choices=datetime_precision_choices,
                                                      default=6)
    _event_end_dt = models.DateTimeField(blank=True, null=True, default=None, verbose_name="Private datetime variable for the start date")
    _event_end_dt_p = models.IntegerField(verbose_name="Private datetime variable for the start date precision",
                                                      choices=datetime_precision_choices,
                                                      default=6)
    decimalLatitude = models.DecimalField(blank=True, null=True, default=None, decimal_places=6, max_digits=8,
    ...
    decimalLongitude = models.DecimalField(blank=True, null=True, default=None, decimal_places=6, max_digits=9,
    ...
    continent = models.CharField(blank=True, null=True, default=None, max_length=127,
    ...
    coordinatePrecision = models.DecimalField(blank=True, null=True, default=None, decimal_places=6, max_digits=7,
    ...
    coordinateUncertaintyInMeters = models.DecimalField(blank=True, null=True, default=None, decimal_places=6, max_digits=12,
    ...
    eventType = models.CharField(blank=True, null=True, default=None, max_length=127,
    ...
    maximumDepthInMeters = models.DecimalField(blank=True, null=True, default=None, decimal_places=3, max_digits=6,
    ...
    minimumDepthInMeters = models.DecimalField(blank=True, null=True, default=None, decimal_places=3, max_digits=6,
    ...
    ####
    footprintWKT = models.CharField(blank=True, null=True, default=None, max_length=511,
    ...
    eventRemarks = models.CharField(max_length=255, blank=True, null=True, default=None, verbose_name="Comments or notes about the dwc:Event.")
    # footprintSRS


class Occurrence(OBISTable):
    occurenceID = models.CharField(primary_key=True, max_length=255, verbose_name="An identifier for the dwc:Occurrence (as opposed to a particular digital record of the dwc:Occurrence). In the absence of a persistent global unique identifier, construct one from a combination of identifiers in the record that will most closely make the dwc:occurrenceID globally unique.")
    ...
    verbatimIdentification = models.CharField(max_length=255, verbose_name="A string representing the taxonomic identification as it appeared in the original record.")
    scientificName = models.CharField(max_length=255, verbose_name="The full scientific name, with authorship and date information if known. When forming part of a dwc:Identification, this should be the name in lowest level taxonomic rank that can be determined. This term should not contain identification qualifications, which should instead be supplied in the dwc:identificationQualifier term.")
    scientificNameID = models.CharField(max_length=255, verbose_name="An identifier for the nomenclatural (not taxonomic) details of a scientific name.")
    basisOfRecord = models.CharField(max_length=255, verbose_name="The specific nature of the data record.")
    occurrenceStatus = models.CharField(max_length=255, verbose_name="A statement about the presence or absence of a dwc:Taxon at a dcterms:Location")
    associatedMedia = models.CharField(blank=True, null=True, default=None, max_length=255, verbose_name="A list (concatenated and separated) of identifiers (publication, global unique identifier, URI) of media associated with the dwc:Occurrence.")
    taxonRemarks = models.CharField(max_length=255, verbose_name="A statement about the presence or absence of a dwc:Taxon at a dcterms:Location")


class eMoF(OBISTable):
    eventID = models.ForeignKey(Event, on_delete=models.CASCADE)
    occurenceID = models.ForeignKey(Occurrence,  on_delete=models.CASCADE)
    measurementType = models.CharField(max_length=255, verbose_name="The nature of the measurement, fact, characteristic, or assertion")
    measurementValue = models.CharField(max_length=255, verbose_name="Recommended best practice is to use a controlled vocabulary. This term has an equivalent in the dwciri: namespace that allows only an IRI as a value, whereas this term allows for any string literal value.")
    measurementUnit = models.CharField(max_length=255, verbose_name="Recommended best practice is to use the International System of Units (SI). This term has an equivalent in the dwciri: namespace that allows only an IRI as a value, whereas this term allows for any string literal value. ")
    measurementTypeID = models.CharField(max_length=255, verbose_name="An identifier for the measurementType (global unique identifier, URI). The identifier should reference the measurementType in a vocabulary.")
    measurementValueID = models.CharField(max_length=255, verbose_name="An identifier for facts stored in the column measurementValue (global unique identifier, URI). This identifier can reference a controlled vocabulary (e.g. for sampling instrument names, methodologies, life stages) or reference a methodology paper with a DOI. When the measurementValue refers to a value and not to a fact, the measurementvalueID has no meaning and should remain empty.")
    measurementRemarks = models.CharField(max_length=255, verbose_name="Comments or notes accompanying the dwc:MeasurementOrFact.")
